    ...
    try {
        ...
        echo json_encode([
          ...
          [
              ...
              'msg' => $admin_update_status && $env_update_status && $import_database ? '<a href="https://weadown.com" target="_blank">weadown.com</a> | Insallation Succssfull, if you still see install notice in your website, clear your browser cache '.'<a href="'.$installation_path.'">visit website</a>' : 'Installation Failed'
          ]
        ]);
