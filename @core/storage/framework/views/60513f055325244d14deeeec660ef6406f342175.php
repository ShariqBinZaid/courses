                    ...
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            ...
                            <div class="btn-wrapper">
                                <a class="btn btn-xs btn-secondary btn-sm mb-3 mr-1"  href="<?php echo e(route('admin.page.edit',$page->id)); ?>">
                                    <?php echo e(__('Go Back')); ?>

                                </a>
                                <a class="btn btn-xs btn-primary btn-sm mb-3 mr-1"  href="<?php echo e(route('admin.page')); ?>">
                                     <?php echo e(__('All pages')); ?>

                                </a>
                                <a class="btn btn-xs btn-info btn-sm mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.dynamic.page',$page->slug)); ?>">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\courses\@core\resources\views/backend/page-builder/dynamicpage.blade.php ENDPATH**/ ?>