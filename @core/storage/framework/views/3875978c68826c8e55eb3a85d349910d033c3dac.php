    ...
    ;(function () {
        ...
        $(document).on('click','.media_upload_modal_submit_btn',function (e) {
            ...
            $(document).on('click','.media_library_image_delete_btn',function (e) {
                e.preventDefault();
                Swal.fire({
                    title: '<?php echo e(__("Are you sure to delete this image")); ?>',
                    text: '<?php echo e(__("This image will remove permanently")); ?>',
                    icon: 'warning',
        ...
        /* loadmore image  */
             $(document).on('click','#loadmorewrap',function (){
                ...
                $('#loadmorewrap button').append(' <i class="fas fa-spinner fa-spin"></i>');
                $('#loadmorewrap button').attr('disabled',true);
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('admin.upload.media.file.loadmore')); ?>",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        'skip' : skipp
                    },
                    success: function (data) {
                        ...
                        $('#loadmorewrap button').attr('disabled',false);
...
<?php /**PATH C:\laragon\www\courses\@core\resources\views/backend/partials/media-upload/media-js.blade.php ENDPATH**/ ?>