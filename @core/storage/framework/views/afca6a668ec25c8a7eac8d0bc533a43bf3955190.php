<style>
    ...
    <?php if(get_static_option('navbar_variant') == '01'): ?>
    /* navbar style 01 */
    .header-style-01.navbar-variant-01 .navbar-area.nav-style-01{
        background-color: <?php echo e(get_static_option('navbar_background_color','transparent')); ?>;
    }
    ...
    {
        color:  <?php echo e(get_static_option('navbar_text_color','rgba(255, 255, 255, .8)')); ?>;
    }
    ...
    {
        color:  <?php echo e(get_static_option('navbar_text_hover_color','var(--main-color-one)')); ?>;
    }
    .header-style-01.navbar-variant-01 .navbar-area.nav-style-01 .nav-container .navbar-collapse .navbar-nav li.menu-item-has-children .sub-menu li a {
        background-color: <?php echo e(get_static_option('navbar_dropdown_background_color','#fff')); ?>;
        color: <?php echo e(get_static_option('navbar_dropdown_text_color','var(--paragraph-color)')); ?>;
    }
    .header-style-01.navbar-variant-01 .navbar-area.nav-style-01 .nav-container .navbar-collapse .navbar-nav li.menu-item-has-children .sub-menu li a:hover {
        background-color: <?php echo e(get_static_option('navbar_dropdown_hover_background_color','var(--main-color-one)')); ?>;
        color: <?php echo e(get_static_option('navbar_dropdown_hover_text_color','#fff')); ?>;
    }
    .header-style-01.navbar-variant-01 .navbar-area .nav-container .navbar-collapse .navbar-nav li.menu-item-has-children .sub-menu{
        border-bottom-color: <?php echo e(get_static_option('navbar_dropdown_border_bottom_color','var(--main-color-one)')); ?>;
    }
    ...
    .header-style-01.navbar-variant-01 .navbar-area .nav-container .nav-right-content ul li.cart .pcount{
        background-color: <?php echo e(get_static_option('navbar_cart_background_color','var(--main-color-one)')); ?>;
        color: <?php echo e(get_static_option('navbar_cart_text_color','#fff')); ?>;
    }
    .navbar-variant-01 .navbar-area .nav-container .navbar-collapse .navbar-nav li.current-menu-item a {
        color: <?php echo e(get_static_option('navbar_dropdown_hover_text_color','#fff')); ?>; !important;
    }
    ...
    <?php endif; ?>
    /* navbar style 02 */
    <?php if(get_static_option('navbar_variant') == '02'): ?>
    ...
    {
        color:  <?php echo e(get_static_option('navbar_text_color','var(--paragraph-color)')); ?>;
    }
    ...
    .navbar-variant-02 .navbar-area .nav-container .navbar-collapse .navbar-nav li.current-menu-item a {
        color: <?php echo e(get_static_option('navbar_dropdown_hover_text_color','var(--main-color-one)')); ?>; !important;
    }
    ...
    .navbar-variant-02 .navbar-area .nav-right-content ul li.cart .pcount{
     ...
     .header-style-03.header-variant-06.navbar-variant-02 .logo-wrapper:after{
        background-color: <?php echo e(get_static_option('navbar_cart_background_color','var(--logistic-color)')); ?>;
    }

    <?php endif; ?>

    /* navbar style 03 */
    <?php if(get_static_option('navbar_variant') == '03'): ?>
    ...
    .navbar-variant-03 .header-style-03.header-variant-07 .navbar-area{
        background-color: <?php echo e(get_static_option('navbar_background_color','#191d33')); ?>;
    }
    ...
    .navbar-variant-03 .industry-support-wrap{
        background-color: <?php echo e(get_static_option('topbar_background_color','#fff')); ?>;
    }
    .navbar-variant-03 .industry-single-info-item .title{
        color: <?php echo e(get_static_option('topbar_info_title_color','var(--heading-color)')); ?>;
    }
    .navbar-variant-03 .industry-single-info-item .icon{
        color: <?php echo e(get_static_option('topbar_info_icon_color','var(--industry-color)')); ?>;
    }
    ...
    .navbar-variant-03 .industry-top-right-list li span{
        color: <?php echo e(get_static_option('topbar_text_color','var(--paragraph-color)')); ?>;
    }
    .navbar-variant-03 .industry-top-right-list li a:hover {
        color: <?php echo e(get_static_option('topbar_text_hover_color','var(--main-color-one)')); ?>;
    }

    <?php endif; ?>

    /* navbar style 04 */
    <?php if(get_static_option('navbar_variant') == '04'): ?>
    ...
    <?php endif; ?>
    /* navbar style 05 */
    <?php if(get_static_option('navbar_variant') == '05'): ?>
    .navbar-variant-05 .navbar-area,
    .navbar-variant-05 .navbar-area .nav-container{
        background-color: <?php echo e(get_static_option('navbar_background_color','var(--secondary-color)')); ?>;
    }
    ...
    .navbar-variant-05 .right-content-wrap li span{
        color: <?php echo e(get_static_option('topbar_text_color','var(--heading-color)')); ?>;
    }
    .navbar-variant-05 .right-content-wrap li a:hover {
        color: <?php echo e(get_static_option('topbar_text_hover_color','var(--heading-color)')); ?>;
    }
     .navbar-variant-05 .construction-support-area .support-inner .boxed-btn {
        background-color: <?php echo e(get_static_option('topbar_button_background_color','var(--main-color-two)')); ?>;
        color: <?php echo e(get_static_option('topbar_button_text_color','#fff')); ?>

    }
     .navbar-variant-05 .construction-support-area .support-inner .boxed-btn:hover {
        background-color: <?php echo e(get_static_option('topbar_button_background_hover_color','var(--main-color-one)')); ?>;
        color: <?php echo e(get_static_option('topbar_button_text_hover_color','#fff')); ?>;
    }

    <?php endif; ?>

    /* navbar style 06 */
    <?php if(get_static_option('navbar_variant') == '06'): ?>
    .navbar-variant-06 .navbar-area .nav-container{
        background-color: <?php echo e(get_static_option('navbar_background_color','#fff')); ?>;
    }
    ...
    /* topbar style */
    .top-bar-area {
        background-color: <?php echo e(get_static_option('topbar_background_color','var(--secondary-color)')); ?>;
    }
    .top-bar-inner ul li a,
    #langchange{
        color: <?php echo e(get_static_option('topbar_text_color','#f2f2f2')); ?>;
    }
    .top-bar-inner ul li a:hover {
        color: <?php echo e(get_static_option('topbar_text_hover_color','var(--main-color-two)')); ?>;
    }
    ...
    .top-bar-inner .btn-wrapper .boxed-btn.reverse-color:hover {
        background-color: <?php echo e(get_static_option('topbar_button_background_hover_color','var(--main-color-two)')); ?>;
        color: <?php echo e(get_static_option('topbar_button_text_hover_color','#fff')); ?>;
    }
    ...
    .xg_mega_menu_wrapper{
        background-color: <?php echo e(get_static_option('mega_menu_background_color','#fff')); ?>;;
    }

    .xg-mega-menu-single-column-wrap .mega-menu-title{
        color: <?php echo e(get_static_option('mega_menu_title_color','var(--heading-color)')); ?>;
    }
    .xg-mega-menu-single-column-wrap ul li a,
    .xg-mega-menu-single-column-wrap ul .single-mega-menu-product-item .title,
    .xg-mega-menu-single-column-wrap ul .single-mega-menu-product-item .content .price-wrap .price,
    .single-donation-mega-menu-item .title{
        color: <?php echo e(get_static_option('mega_menu_text_color','var(--paragraph-color)')); ?> !important;
    }
    ...
    .single-donation-mega-menu-item .title:hover{
        color: <?php echo e(get_static_option('mega_menu_text_hover_color','var(--main-color-color)')); ?> !important;
    }
    ...
    .single-donation-mega-menu-item .content .boxed-btn{
        background-color: <?php echo e(get_static_option('mega_menu_button_background_color','var(--main-color-one)')); ?>;
        color: <?php echo e(get_static_option('mega_menu_button_text_color','#fff')); ?> !important;
    }
    .single-donation-mega-menu-item .content .boxed-btn:hover{
        background-color: <?php echo e(get_static_option('mega_menu_button_background_hover_color','var(--main-color-one)')); ?> ;
        color: <?php echo e(get_static_option('mega_menu_button_text_hover_color','#fff')); ?> !important;
    }
    /* breadcrumb css */
    .breadcrumb-area .breadcrumb-inner{
        padding-top: <?php echo e(get_static_option('breadcrumb_padding_top',215)); ?>px;
        padding-bottom: <?php echo e(get_static_option('breadcrumb_padding_bottom',142)); ?>px;
    }
    .breadcrumb-area:before{
        background-color: <?php echo e(get_static_option('breadcrumb_background_overlay_color','rgba(0, 0, 0, .6)')); ?> ;
    }
    .breadcrumb-area .page-title{
        color: <?php echo e(get_static_option('breadcrumb_title_color','#fff')); ?>;
    }
    .breadcrumb-area .page-list li:first-child a{
        color: <?php echo e(get_static_option('breadcrumb_text_active_color','var(--main-color-one)')); ?>;
    }
    .breadcrumb-area .page-list li{
        color: <?php echo e(get_static_option('breadcrumb_text_color','rgba(255, 255, 255, .7)')); ?>;
    }

    /* footer css */
    .footer-area .copyright-area{
        background-color:<?php echo e(get_static_option('footer_copyright_area_background_color','#2d316a')); ?> !important;
        color: <?php echo e(get_static_option('footer_copyright_area_text_color','rgba(255, 255, 255, .7)')); ?>;
    }
    .footer-area .footer-top {
        background-color: <?php echo e(get_static_option('footer_background_color','#202353')); ?> !important;
    }
    .widget.footer-widget .widget-title {
        color: <?php echo e(get_static_option('footer_widget_title_color','rgba(255, 255, 255, .9)')); ?>;
    }
    .contact_info_list li.single-info-item .icon,
    .footer-widget.widget_nav_menu ul li a:after
    {
        color: <?php echo e(get_static_option('footer_widget_icon_color','var(--main-color-two)')); ?>;
    }
    ...
    .footer-area .widget.footer-widget ul li a {
        color: <?php echo e(get_static_option('footer_widget_text_color','rgba(255, 255, 255, .6)')); ?>;
    }

    .footer-area .footer-widget.widget_tag_cloud .tagcloud a:hover,
    .footer-area .widget.footer-widget ul li a:hover {
        color: <?php echo e(get_static_option('footer_widget_text_hover_color','rgba(255, 255, 255, .6)')); ?>;
    }

</style><?php /**PATH C:\laragon\www\courses\@core\resources\views/frontend/partials/navbar-css.blade.php ENDPATH**/ ?>