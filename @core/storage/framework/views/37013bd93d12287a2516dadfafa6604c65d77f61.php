                                    ...
                                    <div class="table-wrap table-responsive">
                                        ...
                                        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-popover','data' => ['url' => route('admin.page.delete',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                                                    <a class="btn btn-xs btn-primary btn-sm mb-3 mr-1" href="<?php echo e(route('admin.page.edit',$data->id)); ?>">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                    <a class="btn btn-xs btn-info btn-sm mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.dynamic.page',$data->slug)); ?>">
                                                        <i class="ti-eye"></i>
                                                    </a>
                                                    <?php if(!empty($data->page_builder_status)): ?>
                                                        <a href="<?php echo e(route('admin.dynamic.page.builder',['type' =>'dynamic-page','id' => $data->id])); ?>" target="_blank" class="btn btn-xs btn-secondary mb-3 mr-1"><?php echo e(__('Open Page Builder')); ?></a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "<?php echo e(route('admin.page.bulk.action')); ?>",
                        'data' : {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\courses\@core\resources\views/backend/pages/page/index.blade.php ENDPATH**/ ?>