    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').ihavecookies({
                ...
                moreBtnLabel: "<?php echo e(get_static_option('site_gdpr_cookie_'.$user_select_lang_slug.'_manage_button_label',"Manage")); ?>",
                cookieTypesTitle: "<?php echo e(get_static_option('site_gdpr_cookie_'.$user_select_lang_slug.'_manage_title',"Manage Cookies")); ?>",
            });
...
<?php endif; ?><?php /**PATH C:\laragon\www\courses\@core\resources\views/frontend/partials/gdpr-cookie.blade.php ENDPATH**/ ?>